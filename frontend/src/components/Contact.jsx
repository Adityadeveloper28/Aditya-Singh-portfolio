      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-10">
            ...
            <div className="flex justify-center gap-4">
              {socialLinks.map((link, index) => (
                <motion.a
                  ...
                  className="p-3 bg-gray-900/50 rounded-full hover:bg-gray-800/50 transition-colors"
          ...
          >
            ...
            <motion.button
              type="submit"
              className="w-full bg-gradient-to-r from-blue-500 to-purple-500 p-3 rounded-lg font-medium"
